...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="{!!asset('resources/upload/'.$product_detail->image)!!}">
			        <div class="thumb-image"> <img src="{!!asset('resources/upload/'.$product_detail->image)!!}" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    @foreach($product_image as $image)
			    <li data-thumb="{!!asset('resources/upload/files/'.$image->image)!!}">
			         <div class="thumb-image"> <img src="{!!asset('resources/upload/files/'.$image->image)!!}" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    @endforeach
			  </ul>
		</div>
...
<div class="col-md-7 single-top-in">
				...
				<p class="in-para">{!!$product_detail->intro!!}</p>
			    <div class="price_single">
				  <span class="reducedfrom item_price">{!!number_format($product_detail->price,0,',','.')!!} VNĐ</span>
				 <a href="#">click for offer</a>
				 <div class="clearfix"></div>
				</div>
				<h4 class="quick">Quick Overview:</h4>
				<p class="quick_desc">{!!$product_detail->content!!}</p>
			    <div class="wish-list">
				 	<ul>
...
<!--//menu-->
 <section  class="sky-form">
	...
	<script src="{!!url('public/user/js/imagezoom.js')!!}"></script>

	<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script defer src="{!!url('public/user/js/jquery.flexslider.js')!!}"></script>
<link rel="stylesheet" href="{!!url('public/user/css/flexslider.css')!!}" type="text/css" media="screen" />
